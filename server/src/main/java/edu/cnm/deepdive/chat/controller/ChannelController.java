...
public class ChannelController {
  ...
  public Channel post(@RequestBody Channel channel) { // FIXME: 3/6/2025 Use ResponseEntity
  ...
  @PutMapping(path = "/{externalKey}/name",
      consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
  public String put(@PathVariable UUID externalKey, @RequestBody String name) {
  ...
  consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
  public boolean putActive(@PathVariable UUID externalKey, boolean active) {
  ...
  public boolean getActive(@PathVariable UUID externalKey, boolean active) {
